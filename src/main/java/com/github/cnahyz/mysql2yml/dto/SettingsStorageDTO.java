...
import com.github.cnahyz.mysql2yml.entity.*;
import com.github.cnahyz.mysql2yml.enums.ColumnConfigType;
import com.github.cnahyz.mysql2yml.enums.TableHeaderEnum;
import com.github.cnahyz.mysql2yml.tool.CollectionUtil;
...
public class SettingsStorageDTO {
    ...
    public static SettingsStorageDTO defaultVal() {
        ...
        columnConfigGroup.setElementList(
                Arrays.asList(new ColumnConfig(TableHeaderEnum.IS_CONVERT.getName(), ColumnConfigType.BOOLEAN),
                        new ColumnConfig(TableHeaderEnum.ADD_OR_MODIFY.getName(), ColumnConfigType.SELECT, "新增字段,修改字段")));
