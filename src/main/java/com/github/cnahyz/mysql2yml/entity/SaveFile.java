package com.github.cnahyz.mysql2yml.entity;

import com.github.cnahyz.mysql2yml.dto.TableOptions;
import com.github.cnahyz.mysql2yml.tool.CompareFileUtils;
import com.github.cnahyz.mysql2yml.tool.FileUtils;
import com.github.cnahyz.mysql2yml.tool.MessageDialogUtils;
...
public class SaveFile {
     ...
     */
    public SaveFile(@NonNull Project project, @NonNull String content, @NonNull Callback callback, @NonNull TableOptions tableOptions) {
    ...
    private VirtualFile titleCreateDir(VirtualFile saveDir, VirtualFile baseDir, String savePath) {
        ...
        if (tableOptions.getTitleSure()) {
            saveDir = fileUtils.createChildDirectory(project, baseDir, savePath);
            return saveDir;
        } else if (tableOptions.getTitleRefuse()) {
            return null;
        } else {
