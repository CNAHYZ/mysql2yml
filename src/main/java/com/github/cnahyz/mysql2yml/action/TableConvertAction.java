...
import com.github.cnahyz.mysql2yml.ui.SelectSavePath;
 ...
 */
public class TableConvertAction extends AnAction {
    public TableConvertAction() {
    }
     ...
     * @param text 菜单名称
     */
    TableConvertAction(@Nullable String text) {
        super(text);
    }
